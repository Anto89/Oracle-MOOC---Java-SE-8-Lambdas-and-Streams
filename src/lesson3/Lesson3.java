...
public class Lesson3 {
  ...
  static int[][] computeLevenshtein(List<String> wordList, boolean parallel) {
    ...
    Supplier<Stream<String>> stream = () -> parallel ? wordList.parallelStream() : wordList.stream();
    
	stream.get().map((String word1) -> stream.get()
			.mapToInt((String word2) -> Levenshtein.lev(word1, word2))
			.toArray())
...
//	List<String> collected = stream.map(String::toLowerCase).sorted().collect(Collectors.toList());
//	List<String> collected = stream.map(String::toLowerCase).collect(Collectors.toList());
//	List<String> collected = stream.filter((String word) -> word.startsWith("alo")).collect(Collectors.toList());
	List<String> collected = stream.distinct().collect(Collectors.toList());
  ...
  public static void main(String[] args) throws IOException {
    ...
    List<String> wordList = fullWordList.createList(120854);
